...
case $opt in
	...
	;;
  "21.10-1247438-ubuntu-20.04")
	wget https://drivers.amd.com/drivers/linux/amdgpu-pro-21.10-1247438-ubuntu-20.04.tar.xz
        version="21.10-1247438-ubuntu-20.04";break
	;;
	"Quit")
	exit
        break
